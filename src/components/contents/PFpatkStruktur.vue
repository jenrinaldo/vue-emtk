<template>
	<div class="m-fnt">
		...
		<h1 class="staggeredAnim content-title">Struktur</h1>
		<h6 class="staggeredAnim content-caption">Fpatk</h6>
		<div class="main-article" v-dragscroll>
			<img class="staggeredAnim" src="/public/images/strukturfpatk.svg">
		</div>
